package id.ridwan.moviecatalogueapp.userInterface.favoriteMovie
...
import id.ridwan.moviecatalogueapp.adapter.DataFavoriteMovieAdapter
import id.ridwan.moviecatalogueapp.helper.MappingHelper.mapFavoriteMovieCursorToArrayList
...
import id.ridwan.moviecatalogueapp.userInterface.favoriteMovie.DetailFavoriteMovieActivity.Companion.REQUEST_UPDATE
import id.ridwan.moviecatalogueapp.userInterface.favoriteMovie.DetailFavoriteMovieActivity.Companion.RESULT_FAVORITE_MOVIE
...
class FavoriteMovieFragment : Fragment() {
    ...
    companion object {
        ...
        const val EXTRA_REMOVED = "extra_removed"
        const val EXTRA_POSITION = "extra_position"
        const val REQUEST_FAVORITE_MOVIE = 66
    }

    lateinit var dataFavoriteMovieAdapter: DataFavoriteMovieAdapter
    ...
    override fun onCreateView(
        ...
        favoriteMovieHelper = FavoriteMovieHelper(context!!)
